...
function initRuntimeSocketService() {
  const hosts = "26.110.251.132,169.254.109.235,169.254.170.73,192.168.43.202,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_iOf2tz";
...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      selectedIconPath: "static/tabbar/notes_selected.png"
    },
    {
      pagePath: "pages/tasks/tasks",
      text: "任务",
      iconPath: "static/tabbar/tasks.png",
      selectedIconPath: "static/tabbar/tasks_selected.png"
    },
    {
